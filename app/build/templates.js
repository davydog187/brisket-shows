...
var t = {
  ...
  'home/home' : new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<h1>Welcome to your first Brisket site!</h1>");t.b("\n");t.b("\n" + i);t.b("<h2>Check out the sides</h2>");t.b("\n" + i);t.b("<strong>Standard route:</strong> <a href=\"sides/mac-and-cheese\">Eat Mac and Cheese</a>");t.b("\n" + i);t.b("<br>");t.b("\n" + i);t.b("<br>");t.b("\n" + i);t.b("<strong>Routes with ajax:</strong>");t.b("\n" + i);t.b("<br>");t.b("\n" + i);t.b("<a href=\"sides/vegetables/green-bean-casserole\">Green Bean Casserole</a>");t.b("\n" + i);t.b("<br>");t.b("\n" + i);t.b("<a href=\"sides/vegetables/polenta\">Polenta</a>");t.b("\n");t.b("\n" + i);t.b("<h2>Check out the error page</h2>");t.b("\n" + i);t.b("<a href=\"500\">Default Error View</a>");t.b("\n");t.b("\n");return t.fl(); },partials: {}, subs: {  }}),
  ...
  'shows/drama' : new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<h1>Show name: ");t.b(t.v(t.f("showName",c,p,0)));t.b("</h1>");t.b("\n");return t.fl(); },partials: {}, subs: {  }}),
